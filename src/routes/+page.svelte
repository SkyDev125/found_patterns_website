			...
			{#each artistInfo.socials as social}
				...
				>
					...
					{:else if social.name.includes('Reddit')}
						<svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.066 13.71c.147.047.236.194.213.348a4.467 4.467 0 0 1-.102.54c-.537 2.186-3.327 3.852-6.677 3.852-3.35 0-6.14-1.666-6.677-3.852a4.467 4.467 0 0 1-.102-.54.282.282 0 0 1 .213-.347A1.482 1.482 0 0 0 6 12.5c0-.828-.56-1.5-1.25-1.5-.345 0-.66.166-.892.434a.285.285 0 0 1-.408.028C2.542 10.67 2 9.403 2 8c0-3.314 4.477-6 10-6s10 2.686 10 6c0 1.403-.542 2.67-1.45 3.462a.285.285 0 0 1-.408-.028A1.336 1.336 0 0 0 19.25 11c-.69 0-1.25.672-1.25 1.5 0 .506.218.953.566 1.21zM8.5 12.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zm7 0a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zm-6.903 4.89a.285.285 0 0 1 .012-.402c1.35-1.35 3.932-1.35 5.282 0a.285.285 0 0 1-.39.414c-1.07-1.07-3.432-1.07-4.502 0a.285.285 0 0 1-.402-.012z"/></svg>
					{:else if social.name.includes('PayPal')}
						<svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.437-.983 5.05-4.349 6.797-8.647 6.797h-2.19c-.524 0-.968.382-1.05.9l-1.12 7.106zm14.146-14.42a3.35 3.35 0 0 0-.607-.541c-.013.076-.026.175-.041.254-.93 4.778-4.005 7.201-9.138 7.201h-2.19a.563.563 0 0 0-.556.479l-1.187 7.527h-.506l-.24 1.516a.56.56 0 0 0 .554.647h3.882c.46 0 .85-.334.922-.788.06-.26.76-4.852.816-5.09a.932.932 0 0 1 .923-.788h.58c3.76 0 6.705-1.528 7.565-5.946.36-1.847.174-3.388-.777-4.471z"/></svg>
					{:else if social.name.includes('BlueSky')}
						<svg width="20" height="20" fill="currentColor" viewBox="0 0 568 501"><path d="M123.121 33.664C188.241 82.553 258.281 181.68 284 234.873c25.719-53.192 95.759-152.32 160.879-201.21C491.866 -4.136 568 -28.895 568 68.938c0 13.346-7.646 112.208-12.141 128.231-15.694 55.848-72.873 70.088-126.242 61.498 93.342 16.202 117.106 67.547 65.843 118.893-97.467 96.506-140.169-24.175-151.099-55.035-1.93-5.46-2.834-8.02-2.852-5.856-.018-2.164-.922.396-2.852 5.856-10.93 30.86-53.631 151.54-151.099 55.035-51.263-51.346-27.499-102.69 65.843-118.893-53.369 8.59-110.548-5.65-126.242-61.498C22.646 181.146 15 82.284 15 68.938c0-97.833 76.134-73.074 108.121-35.274z"/></svg>
					...
					{:else if social.name.includes('Webtoon')}
						<svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M2 2C.9 2 0 2.9 0 4v12c0 1.1.9 2 2 2h5l5 4 5-4h5c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2H2zm5 10.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/></svg>
					{/if}
				</a>
			{/each}
		</div>
